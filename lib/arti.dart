...
class Arti extends StatelessWidget {
  ...
  final Uri _url = Uri.parse('https://forms.gle/cesU88pTxiRXGGKNA');
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    color: Colors.white,
                    child: InkWell(
                      onTap: () {Navigator.pushNamed(context, '/pembelajaran');},
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(
                          children: [
                  ...
                  Container(
                    ...
                    color: Colors.grey.shade200,
                    child: InkWell(
                      onTap: () {Navigator.pushNamed(context, '/penerapan');},
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(
                          children: [
