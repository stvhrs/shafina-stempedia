...
,
  ...
  const Divider(),
   Commnet('pembelajaran'),
  const CommentFrom('pembelajaran')
];
List<Widget> penerapanWidgets=[
  Image.asset('image/4.1.png'),
  const Text(textAlign:TextAlign.justify,'Setelah mempelajari tentang karakteristik dan prinsip dasar STEM, pada bagian selanjutnya kita akan mempelajari tentang metode penerapan STEM. Pada bagian pertama, kita telah mempelajari tentang tingkatan STEM dari STEM 1.0 sampai STEM 4.0. Berdasarkan tingkatan tersebut, STEM dapat diterapkan dengan berbagai metode. Apa saja metode tersebut? Mari kita simak penjelasan berikut.\n'),
    Text(textAlign:TextAlign.justify,'Apa Saja Metode Penerapan STEM?\n',style: big,),
    const Text(textAlign:TextAlign.justify,'Metode penerapan STEM terus menerus dievaluasi agar implementasi STEM dapat berjalan secara efektif. Roberts & Cantu (2012) mengembangkan 3 metode dalam penerapan STEM antara lain pendekatan silo (terpisah), pendekatan embedded (tertanam), dan pendekatan integrasi (terpadu).\n'),
    Text(textAlign:TextAlign.justify,'Pendekatan Silo\n',style: bold,),
    const Text(textAlign:TextAlign.justify,'Silo merupakan salah satu metode penerapan STEM dimana antara disiplin STEM dilaksanakan secara terpisah sehingga pendekatan ini termasuk dalam level STEM 1.0. Penerapan secara terpisah ini beberapa kelebihan seperti untuk memudahkan siswa memperoleh pengetahuan yang mendalam. Penerapan STEM dengan pendekatan silo akan mengajarkan siswa untuk learning by doing sehingga mereka mendapatkan pengetahuan berdasarkan keputusan terbaik. Melalui learning by doing, siswa terlibat secara aktif untuk memecahkan permasalahan pembelajaran menjadi bermakna. Pembelajaran bermakna akan memberikan kemudahan kepada siswa untuk mengingat lebih lama dan memudahkan dalam mempelajari konsep lain yang berkaitan (Rahmah, 2018).\n'),
...
Text(textAlign:TextAlign.justify,'Problem-based learning terintegrasi STEM (PBL-STEM)',style: bold,),
const Text(textAlign:TextAlign.justify,'Belajar dari masalah merupakan dasar dari kehidupan manusia. Dalam rangka menyelesaikan permasalahan, maka akan terjadi pembelajaran. Pembelajaran berbasis masalah atau Problem-based learning (PBL) merupakan proses dasar dalam pembelajaran yang dilakukan manusia sebagai usaha untuk mempertahankan diri di lingkungan. Model pembelajaran PBL pertama kali diperkenalkan pada 1960 di pendidikan tingkat tinggi dan didefinisikan sebagai kegiatan pembelajaran yang menghasilkan suatu pemahaman/pengetahuan dari proses penyelesaian masalah (Barrows & Tamblyn, 1980). PBL sangat cocok diterapkan pada pembelajaran berbasis STEM karena memiliki karakteristik yang sama, yaitu menekankan pada proses penyelesaian masalah (Smith et al., 2022).\n'),
const Text(textAlign:TextAlign.justify,'    Menerapkan PBL dalam pembelajaran berbasis STEM akan membantu siswa untuk mengembangkan kemampuan pemecahan masalah dan berpikir kritis dengan berkolaborasi pada kelompok kecil melalui pembelajaran yang bermakna. Melalui PBL, siswa akan lebih diarahkan untuk mengintegrasikan aspek-aspek STEM untuk menyelesaikan permasalahan. Sesuai dengan teori belajar bermakna yang disampaikan oleh Ausubel (2000) menyatakan bahwa  siswa akan membangun pengetahuannya dengan cara mengaitkan informasi baru dengan informasi lain yang mungkin sudah melekat dalam struktur kognitif siswa. Pembelajaran berbasis PBL-STEM diawali dengan masalah. Menurut Bransford & Stein (1993) terdapat 5 langkah pembelajaran berbasis masalah antara lain problem identify, define goal, explore possible strategy, anticipate & act, dan look back & learn. Mengadopsi langkah pembelajaran tersebut, pada kegiatan pelatihan implementasi kurikulum 2013 (Ningsih, 2020) PBL-STEM dapat dilihat pada gambar 4.6.\n')
,Center(child: Image.asset('image/4.9.jpg')),
Image.asset('image/4.10.png'),
const Text(textAlign:TextAlign.justify,'Setelah teori STEM yang telah kalian pelajari sebelumnya, pada bagian ini akan disajikan contoh implementasi STEM dalam pembelajaran IPA. Pada bagian ini, kita akan menentukan aspek science, technology, engineering, dan mathematics pada materi IPA.\n'),
Text(textAlign:TextAlign.justify,'Seperti Apa Contoh Implementasi STEM dalam Pembelajaran IPA?\n',style: big,),
const Text(textAlign:TextAlign.justify,'Seperti pada materi sebelumnya, STEM dapat diterapkan dalam pembelajaran melalui model-model pembelajaran. Beberapa model pembelajaran yang dapat diterapkan adalaha project-based learning (PjBL) dan problem-based learning (PBL). Berikut ini disajikan beberapa contoh penerapan STEM dalam pembelajaran IPA.\n'),
Text(textAlign:TextAlign.justify,'Model Freezer Penyimpan Makanan',style: bold,),
Text(textAlign:TextAlign.justify,'Tujuan Pembelajaran:',style: bold,),
const Text(textAlign:TextAlign.justify,'Tujuan pembelajaran ini adalah untuk mengetahui bahan material untuk membuat model freezer yang paling efektif dalam menahan perubahan suhu.\n'),
Text(textAlign:TextAlign.justify,'Deskripsi:\n',style: bold,),
const Text(textAlign:TextAlign.justify,'Sebagian besar mata pencaharian masyarakat Indonesia adalah nelayan. Berbagai jenis ikan dipasarkan kepada warga, baik dipasarkan langsung maupun melalui penjual. Untuk menjual ikan di pasar, para nelayan perlu menjaga agar ikan tetap segar. Salah satu cara untuk menjaga ikan agar tetap segar selama perjalanan dari pantai ke pasar adalah dengan menggunakan freezer atau pendingin. Untuk mendapatkan freezer dengan kualitas terbaik dan harga terjangkau, para nelayan mencoba melakukan proyek untuk membuat model freezer menggunakan material yang ada. Berikut ini adalah beberapa alat dan bahan yang dibutuhkan oleh para nelayan dalam membuat model freezer.\n'),
Text(textAlign:TextAlign.justify,'Alat dan Bahan:\n',style: bold,),
...
Text(textAlign:TextAlign.justify,'Langkah Kerja:\n',style: bold,),
Text(textAlign:TextAlign.justify,'Reflection\n',style: bold,),
const Text(textAlign:TextAlign.justify,'Guru menyampaikan kompetensi dasar materi transfer energi, menyampaikan kegiatan pembelajaran yang akan dilakukan, menjelaskan produk yang akan dibuat dengan menghubungkan dengan STEM. Guru menyampaikan gambaran fenomena dalam kehidupan nyata berupa dua buah sendok dengan bahan yang berbeda, yaitu sendok besi dan sendok plasti. Kemudian guru meminta siswa untuk menempelkan masing-masing sendok ke kulit siswa. Kemudian guru bertanya, “bagaimana rasanya saat kedua sendok ditempelkan di kulit? Sendok mana yang memiliki suhu lebih rendah? Mengapa demikian?”.\n'),
const Text(textAlign:TextAlign.justify,'Selanjutnya, guru mengaitkan tentang kegiatan nelayan yang ingin membuat freezer untuk membantu membawa ikan ke pasar. Guru bertanya “Bagaimana model freezer yang dapat dibuat dengan bahan-bahan terjangkau namun mampu mempertahankan suhu agar kesegaran ikan tetap terjaga hingga ke pasar?”. Kemudian guru memberikan daftar bahan dan perubahan suhu bahan tersebut. Selain itu, guru juga memberikan harga pada setiap bahan.\n'),
Image.asset('image/daftar.jpg'),
const Text(textAlign:TextAlign.justify,'Setelah memberikan daftar perubahan suhu dan harga barang, guru memberikan tantangan kepada siswa untuk mebuat sebuah model dengan bahan-bahan yang disediakan dengan harga maksimal Rp. 100.000 rupiah\n'),
Text(textAlign:TextAlign.justify,'Design\n',style: bold,),
const Text(textAlign:TextAlign.justify,'Pada tahap ini, guru meminta siswa bersama kelompoknya mencari informasi sebanyak-banyaknya tentang freezer dan bahan-bahan pembuatan yang dapat digunakan.\n'),
Text(textAlign:TextAlign.justify,'Discovery\n',style: bold,),
const Text(textAlign:TextAlign.justify,'Guru memberikan kesempatan kepada siswa untuk membuat beberapa desain dalam prototipe freezer. Berikut ini beberapa contoh desain yang telah dibuat.\n'),
Center(child: Image.asset('image/4.12.jpg')),
Text(textAlign:TextAlign.justify,'Application\n',style: bold,),
const Text(textAlign:TextAlign.justify,'Berdasarkan desian yang telah dibuat, guru meminta siswa untuk menerapkannya dalam bentuk sebuah alat menggunakan bahan-bahan yang telah disediakan. Kemudian, siswa diminta untuk menguji prototipe yang telah dibuat dengan cara memasukkan es ke dalam alat dan mengamati perubahan massa es setelah 3 menit.\n'),
Text(textAlign:TextAlign.justify,'Communication\n',style: bold,),
const Text(textAlign:TextAlign.justify,'Pada tahap ini, guru meminta masing-masing kelompok melakukan presentasi terhadap hasil prototipe di depan kelas. Kemudian, guru melakukan refleksi dan menarik kesimpulan berdasarkan hasil presentasi siswa. Guru dapat membuat tabel perbandingan model freezer siswa untuk mengetahui model yang paling efektif. \n'),
...
List<Widget> artiWidgets = [
  ...
  const Text(
      '     President’s Council of Advisors on Science and Technology (Khairiyah, 2019) menjelaskan 4 tujuan pembelajaran berbasis STEM yang dapat dilihat pada Tabel 1\n'),
